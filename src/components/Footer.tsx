    ...
    <footer className="bg-[#111827]">
        <div className="w-11/12 mx-auto py-12">
            <div className="md:grid grid-cols-4 gap-5 text-[#D6D6D6] ">
                <div className="mb-6">
                    <img src="public/miles white.png" alt=""  className="w-[102px] mb-4"/>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="email" placeholder="Your email" className="p-4  bg-[#FFFFFF33] rounded-[8px] w-full border-none text-[#D6D6D6]"/>
                        <button className="absolute top-2 right-2 p-2 bg-[#FF4F00] rounded-[8px] w-[90px] text-white mb-4 hover:bg-[#FF4F39] hover:cursor-pointer font-semibold">JOIN</button>
                    </div>
                    <div className="flex items-center gap-4 mt-4">
                        <a href="/" target="_blank"><img src="public/streamline-plump_facebook-1.svg" alt="" /></a>
                        <a href="http://" target="_blank" rel="noopener noreferrer"><img src="public/linkedin-01.svg" alt="" /></a>
                        <a href="http://" target="_blank" rel="noopener noreferrer"><img src="public/iconoir_google.svg" alt="" /></a>
                        <a href="http://" target="_blank" rel="noopener noreferrer"><img src="public/instagram.svg" alt="" /></a>
                        <a href="http://" target="_blank" rel="noopener noreferrer"><img src="public/new-twitter-rectangle.svg" alt="" /></a>
                    </div>
                </div>
            </div>
