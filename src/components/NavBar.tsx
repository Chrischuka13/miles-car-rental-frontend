      ...
      <header className="">
        <nav className="fixed w-full z-20 bg-neutral-100 transition hover:cursor-pointer ">
          <div className="w-11/12 container p-4 mx-auto flex justify-between items-center">
            <img src="public/miles.png" alt="logo" className="w-[100px]" />
            <div className="hidden lg:flex gap-6 items-center text-[#0A0A0A]">
              <a href="/" className="block font-normal text-xl hover:text-gray-400 hover:cursor-pointer mb-4">
                Home
              </a>
              <a href="/" className="block font-normal text-xl hover:text-gray-400 hover:cursor-pointer mb-4">
                Cars
            ...
            {isLoggedIn ? (
              ...
              <div className="hidden lg:flex items-center gap-3">
                ...
                <Link
                  ...
                  className="bg-[#F97316] text-white px-4 py-2 rounded-3xl text-xl font-normal hover:opacity-90"
                >
                  Sign Up
                </Link>
              </div>
              ...
              <div className="w-11/12 container mx-auto py-4">
                ...
                {isLoggedIn ? (
                  ...
                  <div className="flex flex-col gap-3 mt-8">
                    ...
                    <Link
                      to="/auth/createAccount"
                      className="bg-[#F97316] text-white px-4 py-2 rounded-3xl text-xl font-normal text-center hover:opacity-90"
                    >
                      Sign Up
                    </Link>
                  </div>
